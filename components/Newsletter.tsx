    ...
    <section className="bg-white border-t border-gray-200">
      <div className="max-w-screen-2xl mx-auto px-6 md:px-10 py-16 md:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-12 lg:gap-20 items-end">
          ...
          {/* Form — выровнен по нижнему краю заголовка */}
          <div className="w-full min-w-[260px] lg:w-[340px]">
            {sent ? (
              ...
              <form onSubmit={submit}>
                ...
                <label className="flex items-center gap-2 mt-3 cursor-pointer">
                  ...
                  />
                  <span className="w-4 h-4 border border-gray-400 rounded-[3px] flex items-center justify-center text-black">
